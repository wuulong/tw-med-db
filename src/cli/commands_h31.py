...
import sqlite3
import typer
from modules.h31_oncology_meta.etl import process_m09_etl
from modules.h31_oncology_meta.fts import create_m09_fts, search_m09_fts
from modules.h31_oncology_meta.metadata_gen import generate_m09_metadata
from src.m00_core.utils_db import get_sqlite_connection, resolve_db_path

h31_app = typer.Typer(name="m09", help="M09 癌症指引與 ClinicalTrials 台灣試驗庫 CLI")


@h31_app.command("build")
def build(
