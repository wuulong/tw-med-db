...
h23_app = typer.Typer(help="M15 tw_nhird_db 台灣健保申報與抽樣資料庫 Gateway CLI 命令集")
console = Console()
...
@h23_app.command("chronic-polypharmacy")
