...
h54_app = typer.Typer(name="m55", help="M55 MIMIC-IV 美國重症臨床資料庫 Gateway 命令集")
from typing import Dict, Any, Optional

from modules.h54_mimic_iv_db.duckdb_engine import resolve_mimic_data_dir, query_patient_from_full_dataset
...
@h54_app.command("icu-trajectory")
def icu_trajectory(
    subject_id: str = typer.Argument(..., help="病患代號 subject_id (如 10000032)"),
    db_path: str = typer.Option("db/med.db", "--db", help="SQLite 資料庫路徑")
):
...
@h54_app.command("mortality-risk")
def mortality_risk(
    ...
    from modules.h54_mimic_iv_db.duckdb_engine import get_duckdb_connection
