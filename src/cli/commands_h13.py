...
from modules.h13_drug_shortage_alert.fts import create_m04_fts, search_m04_fts
from modules.h13_drug_shortage_alert.metadata_gen import generate_m04_metadata
from src.m00_core.utils_db import get_sqlite_connection, resolve_db_path

h13_app = typer.Typer(name="m04", help="M04 台灣食藥署缺藥與藥品回收警訊庫 CLI")


@h13_app.command("build")
def build(
