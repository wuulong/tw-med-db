...
from modules.h40_med_lab_fhir_db.fts import create_m12_fts, search_m12_fts
from modules.h40_med_lab_fhir_db.metadata_gen import generate_m12_metadata
from src.m00_core.utils_db import get_sqlite_connection, resolve_db_path

h40_app = typer.Typer(name="m12", help="M12 TW Core IG (FHIR R4) 與 LOINC 檢驗碼庫 CLI")


@h40_app.command("build")
def build(
