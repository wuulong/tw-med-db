...
def cohort_ed_analysis(
    ...
    from modules.h55_mimic_iv_ed_db.duckdb_ed_engine import get_duckdb_connection
...
@h55_app.command("admission-rate")
def admission_rate(
