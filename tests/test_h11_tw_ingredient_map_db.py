...
from modules.h11_tw_ingredient_map_db.fts import search_m02_fts
from modules.h11_tw_ingredient_map_db.metadata_gen import generate_m02_metadata
from modules.h11_tw_ingredient_map_db.etl import normalize_ingredient_name, parse_complex_ingredients
...
class TestM02TwIngredientMapDbDomain(unittest.TestCase):
    ...
    def test_m02_07_cli_runner_e2e_commands(self):
        ...
        # 測試 m02 search 指令
        res_search = runner.invoke(app, ["h11", "search", "GLUCOSE", "--db", self.db_path])
