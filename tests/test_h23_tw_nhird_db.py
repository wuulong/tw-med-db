...
from src.cli.commands_h23 import h23_app, resolve_db_path, get_sqlite_connection
...
class TestM15TWNHIRDDB(unittest.TestCase):
    ...
    def test_02_search_command(self):
        ...
        res = runner.invoke(h23_app, ["search", "TW_P000001", "--db", self.db_path])
    ...
    def test_03_drg_calc_command(self):
        ...
        res = runner.invoke(h23_app, ["drg-calc", "TW_P000002", "--db", self.db_path])
        self.assertEqual(res.exit_code, 0)
    ...
    def test_04_top_nhi_drugs_command(self):
        ...
        res = runner.invoke(h23_app, ["top-nhi-drugs", "--limit", "5", "--db", self.db_path])
        self.assertEqual(res.exit_code, 0)
    ...
    def test_05_chronic_polypharmacy_command(self):
        ...
        res = runner.invoke(h23_app, ["chronic-polypharmacy", "--min-days", "28", "--db", self.db_path])
        self.assertEqual(res.exit_code, 0)
    ...
    def test_06_cross_eval_command(self):
        ...
        res = runner.invoke(h23_app, ["cross-eval", "diabetes", "--db", self.db_path])
        self.assertEqual(res.exit_code, 0)
    ...
    def test_07_status_command(self):
        ...
        res = runner.invoke(h23_app, ["status", "--db", self.db_path, "-j"])
        self.assertEqual(res.exit_code, 0)
