"""
metadata_gen.py - M11 Manifest 與 sys_module_metadata 註冊腳本
"""
...
def generate_m11_metadata(db_path: str, record_count: int, output_manifest: str = "tw-med-db/metadata.json") -> Dict[str, Any]:
    """
    產出 M11 Manifest 檔案並註冊至 sys_module_metadata。
    """
    ...
    metadata = {
        "module_id": "M11",
        "module_name": "patient_journey_db",
        "title": "台灣病患全程臨床旅程 GraphRAG 資料庫",
        "table_name": "m11_journey_nodes",
