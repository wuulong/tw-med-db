"""
metadata_gen.py - M08 Manifest 與 sys_module_metadata 註冊腳本
"""
...
def generate_m08_metadata(db_path: str, record_count: int, output_manifest: str = "tw-med-db/metadata.json") -> Dict[str, Any]:
    """
    產出 M08 Manifest 檔案並註冊至 sys_module_metadata。
    """
    ...
    metadata = {
        "module_id": "M08",
        "module_name": "rare_disease_db",
        "title": "台灣國健署罕見疾病與孤兒藥名單資料庫",
        "table_name": "m08_rare_diseases",
        "schema_version": "1.0.0",
        "record_count": real_count,
        "last_updated": datetime.now().isoformat(),
        "attributes_count": 4,
        "data_sources": [
            "衛生福利部國民健康署 - 公告罕見疾病名單與孤兒藥專案"
        ]
    }
