"""
metadata_gen.py - M04 Manifest 與 sys_module_metadata 註冊腳本
"""
...
def generate_m04_metadata(db_path: str, record_count: int, output_manifest: str = "tw-med-db/metadata.json") -> Dict[str, Any]:
    """
    產出 M04 Manifest 檔案並註冊至 sys_module_metadata。
    """
    ...
    metadata = {
        "module_id": "M04",
        "module_name": "drug_shortage_alert",
        "title": "食藥署缺藥通報與藥品回收警訊資料庫",
        "table_name": "m04_recalls",
        "schema_version": "1.0.0",
        "record_count": real_count,
        "last_updated": datetime.now().isoformat(),
        "attributes_count": 5,
        "data_sources": [
            "TFDA 衛生福利部食品藥物管理署 - 藥品回收與缺藥公告資料集"
        ]
    }
