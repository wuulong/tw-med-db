"""
metadata_gen.py - M12 Manifest 與 sys_module_metadata 註冊腳本
"""
...
def generate_m12_metadata(db_path: str, record_count: int, output_manifest: str = "tw-med-db/metadata.json") -> Dict[str, Any]:
    """
    產出 M12 Manifest 檔案並註冊至 sys_module_metadata。
    """
    ...
    metadata = {
        "module_id": "M12",
        "module_name": "med_lab_fhir_db",
        "title": "TW Core IG (FHIR R4) 與 LOINC 檢驗碼對照庫",
        "table_name": "m12_loinc_codes",
        "schema_version": "1.0.0",
        "record_count": real_count,
        "last_updated": datetime.now().isoformat(),
        "attributes_count": 4,
        "data_sources": [
            "LOINC Official Standard Database (Regenstrief Institute)",
            "衛福部 TW Core IG (FHIR R4) 台灣核心實作指引"
        ]
    }
