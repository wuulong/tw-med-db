"""
metadata_gen.py - M09 Manifest 與 sys_module_metadata 註冊腳本
"""
...
def generate_m09_metadata(db_path: str, record_count: int, output_manifest: str = "tw-med-db/metadata.json") -> Dict[str, Any]:
    """
    產出 M09 Manifest 檔案並註冊至 sys_module_metadata。
    """
    ...
    metadata = {
        "module_id": "M09",
        "module_name": "oncology_meta",
        "title": "台灣癌症臨床指引與 ClinicalTrials 試驗資料庫",
        "table_name": "m09_clinical_trials",
        "schema_version": "1.0.0",
        "record_count": real_count,
        "last_updated": datetime.now().isoformat(),
        "attributes_count": 4,
        "data_sources": [
            "ClinicalTrials.gov - Taiwan Cancer Trials Registry",
            "衛福部國民健康署 - 癌症診療指引"
        ]
    }
