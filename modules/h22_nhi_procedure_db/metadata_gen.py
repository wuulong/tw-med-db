"""
metadata_gen.py - M07 Manifest 與 sys_module_metadata 註冊腳本
"""
...
def generate_m07_metadata(db_path: str, record_count: int, output_manifest: str = "tw-med-db/metadata.json") -> Dict[str, Any]:
    """
    產出 M07 Manifest 檔案並註冊至 sys_module_metadata。
    """
    ...
    metadata = {
        "module_id": "M07",
        "module_name": "nhi_procedure_db",
        "title": "台灣健保醫療服務處置與手術碼資料庫",
        "table_name": "m07_procedures",
        "schema_version": "1.0.0",
        "record_count": real_count,
        "last_updated": datetime.now().isoformat(),
        "attributes_count": 4,
        "data_sources": [
            "衛生福利部中央健康保險署 - 醫療服務給付項目及支付標準"
        ]
    }
