"""
metadata_gen.py - M05 Manifest 與 sys_module_metadata 註冊腳本
"""
...
def generate_m05_metadata(db_path: str, record_count: int, output_manifest: str = "tw-med-db/metadata.json") -> Dict[str, Any]:
    """
    產出 M05 Manifest 檔案並註冊至 sys_module_metadata。
    """
    ...
    metadata = {
        "module_id": "M05",
        "module_name": "tw_hospital_db",
        "title": "台灣健保特約醫事機構與專科地圖資料庫",
        "table_name": "m05_hospitals",
        "schema_version": "1.0.0",
        "record_count": real_count,
        "last_updated": datetime.now().isoformat(),
        "attributes_count": 6,
        "data_sources": [
            "衛生福利部中央健康保險署 - 健保特約醫事機構開放資料集"
        ]
    }
