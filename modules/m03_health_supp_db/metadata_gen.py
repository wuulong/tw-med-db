"""
metadata_gen.py - M03 Manifest 與 sys_module_metadata 註冊腳本
"""
...
def generate_m03_metadata(db_path: str, record_count: int, output_manifest: str = "tw-med-db/metadata.json") -> Dict[str, Any]:
    """
    產出 M03 Manifest 檔案並註冊至 sys_module_metadata。
    """
    ...
    metadata = {
        "module_id": "M03",
        "module_name": "health_supp_db",
        "title": "台灣健康食品許可證與保健功效資料庫",
        "table_name": "m03_health_supp_db",
        "schema_version": "1.0.0",
        "record_count": real_count,
        "last_updated": datetime.now().isoformat(),
        "attributes_count": 5,
        "data_sources": [
            "TFDA 衛生福利部食品藥物管理署 - 健康食品資料集"
        ]
    }
